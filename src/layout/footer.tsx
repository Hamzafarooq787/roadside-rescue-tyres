...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="relative bg-[#102122] text-gray-300 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          >
            <div className="flex items-center gap-2">
              <div className="w-12 h-12 bg-[#25E2F4] rounded-xl flex items-center justify-center text-black font-bold text-2xl shadow-lg">
                RRT
              </div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="flex items-center gap-2 text-gray-400 hover:text-[#25E2F4] transition-colors group"
                  >
                    <ChevronRight size={16} className="text-gray-500 group-hover:text-[#25E2F4] group-hover:translate-x-1 transition-all" />
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-[#1C3537] rounded-lg flex items-center justify-center text-gray-300">
                <MapPin size={20} />
              </div>
              <span className="text-gray-300">Nationwide Coverage</span>
            </div>
            <div className="pt-4 border-t border-gray-800">
              <h4 className="text-sm font-semibold text-[#25E2F4] uppercase tracking-wider mb-2">
                Company Reg
              </h4>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                <div className="w-10 h-10 bg-[#1C3537] rounded-lg flex items-center justify-center text-gray-300 group-hover:bg-[#25E2F4] group-hover:text-black transition-all">
                  <Phone size={20} />
                </div>
                <span className="text-gray-300 group-hover:text-[#25E2F4] transition-colors">
                  0333 577 8247
                </span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-gray-300 group-hover:text-[#25E2F4] transition-colors text-sm">
      ...
      <div className="relative z-10 border-t border-gray-800 bg-[#102122]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          ...
          <Link href="/terms" className="hover:text-[#25E2F4] transition-colors">
            Terms & Conditions
          </Link>
        </div>
      </div>
