  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="py-20 bg-gradient-to-b from-[#00E0C6]/90 to-[#004d40] text-center text-white overflow-hidden relative">
          {/* decorative icons */}
        ...
        <section className="w-full flex flex-col md:flex-row">
          {/* LEFT SIDE */}
          <div className="w-full md:w-1/2 bg-[#00E0C6] flex items-center justify-center py-16 relative overflow-hidden">
            <Image
          ...
          <div className="w-full md:w-1/2 bg-[#0a2a28] flex items-center justify-center py-16 animate-fadeIn shadow-inner">
            <div className="text-center text-white max-w-md">
              <h2 className="text-3xl md:text-4xl font-bold text-[#00E0C6] mb-6 animate-slideRight drop-shadow-md">
              ...
              <p className="mb-4 tracking-wider text-gray-300 flex items-center justify-center gap-2">
                <Phone className="text-[#00E0C6]" size={20} />
                CALL US NOW
              </p>

              <a
                href="tel:03335778247"
                className="block bg-[#00E0C6] text-black font-bold py-3 mb-6 hover:scale-105 transition transform duration-300 shadow-lg"
              >
                0333 577 8247
              </a>

              <p className="text-gray-300 mb-3 flex items-center justify-center gap-2">
                <MapPin className="text-[#00E0C6]" size={20} />
              ...
              <input
                type="text"
                placeholder=""
                className="w-full mb-4 px-4 py-3 text-black border-2 border-[#00E0C6] focus:ring-2 focus:ring-[#00E0C6]/50 outline-none shadow-md"
              />

              <button className="w-full bg-[#00E0C6] text-black py-3 font-semibold hover:scale-105 transition transform duration-300 shadow-lg">
                SUBMIT
              </button>
            </div>
          </div>
        ...
        <section className="bg-[#0a1f1e] py-16 relative overflow-hidden">
          {/* Background tyre pattern */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-10 left-10">
              <TyreIcon className="w-24 h-24 text-[#00E0C6]" />
            </div>
            <div className="absolute bottom-10 right-10">
              <TyreIcon className="w-32 h-32 text-[#00E0C6]" />
            </div>
            <div className="absolute top-1/2 left-1/4 -translate-y-1/2">
              <TyreIcon className="w-20 h-20 text-[#00E0C6] rotate-45" />
            </div>
          </div>
          ...
          <div className="container relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Service 1 */}
              <div className="group relative bg-[#15312e] rounded-2xl overflow-hidden border border-[#00E0C6]/40 shadow-2xl hover:shadow-[#00E0C6]/30 hover:shadow-2xl transition-all duration-500 animate-slideLeft">
                ...
                <div className="relative h-64 w-full">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#15312e] via-transparent to-transparent"></div>
                  {/* Small icon overlay on image */}
                  <div className="absolute bottom-4 left-4 bg-[#00E0C6] p-2 rounded-full shadow-lg">
                ...
                <div className="p-6 relative">
                  <h3 className="text-2xl font-bold text-white mb-3 flex items-center gap-2">
                    <TyreIcon className="w-6 h-6 text-[#00E0C6]" />
                  ...
                  <div className="mt-4 flex items-center text-[#00E0C6]">
              ...
              {/* Service 2 */}
              <div className="group relative bg-[#15312e] rounded-2xl overflow-hidden border border-[#00E0C6]/40 shadow-2xl hover:shadow-[#00E0C6]/30 hover:shadow-2xl transition-all duration-500 animate-slideRight">
                <div className="absolute -right-6 -top-6 opacity-20 group-hover:opacity-30 transition-opacity">
                  <TyreIcon className="w-32 h-32 text-[#00E0C6]" />
                </div>
            ...
            <div className="text-center mt-12">
              <Button className="bg-[#00E0C6] hover:bg-[#00B3A0] text-black font-bold px-8 py-6 rounded-full text-lg transition-all hover:scale-105 shadow-xl">
                VIEW ALL SERVICES
              </Button>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-r from-[#00E0C6]/20 to-[#00E0C6]/5 py-16">
          <div className="container">
            <h2 className="text-3xl font-bold text-center text-[#00E0C6] animate-fadeUp drop-shadow">
              We specialise in
            </h2>
        ...
        <section className="grid md:grid-cols-2">
          ...
          <div className="bg-[#00E0C6]/10 p-12 flex flex-col justify-center animate-slideRight shadow-inner">
            <h3 className="text-2xl font-bold text-[#00E0C6] mb-4 flex items-center gap-2">
              <Award className="text-[#00E0C6]" /> EMERGENCY MOBILE TYRE FITTING
            </h3>
            ...
            <Button className="w-fit bg-[#00E0C6] hover:bg-[#00B3A0] text-black shadow-lg" asChild>
        ...
        <section className="grid md:grid-cols-2">
          ...
          <div className="bg-[#00E0C6]/10 p-12 flex flex-col justify-center order-2 md:order-1 animate-slideLeft shadow-inner">
            <h3 className="text-2xl font-bold text-[#00E0C6] mb-4 flex items-center gap-2">
            ...
            <p className="font-semibold text-[#00E0C6] mb-4">24-7 availability</p>
            <Button className="w-fit bg-[#00E0C6] hover:bg-[#00B3A0] text-black shadow-lg" asChild>
              <a href="tel:03331234567">BOOK NOW</a>
            </Button>
          </div>
        ...
        <section className="bg-gradient-to-b from-[#00E0C6]/5 to-transparent py-16">
          <div className="container">
            <h2 className="text-3xl font-bold text-center mb-12 text-[#00E0C6] animate-fadeUp flex items-center justify-center gap-2 drop-shadow">
              <Star className="text-[#00E0C6]" fill="#00E0C6" /> Hear from our satisfied clients
            </h2>
            <TestimonialsCarousel />
          </div>
        </section>

        <div className="border-t border-[#00E0C6]/20" />
      </main>
      <Footer />
      <CookieConsent/>
    </>
