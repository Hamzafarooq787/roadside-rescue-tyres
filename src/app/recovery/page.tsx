      ...
      <main>
        ...
        >
          ...
          <div className="relative z-20 container mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              <motion.div variants={scaleIn} className="flex justify-center md:justify-start mb-4">
                <motion.div
                  ...
                  className="w-24 h-24 bg-[#8AE600] rounded-full flex items-center justify-center text-black font-bold shadow-lg"
                >
              ...
              <motion.h2 variants={fadeInUp} className="text-xl md:text-2xl font-semibold text-[#8AE600]">
            ...
            <motion.div
              ...
              className="bg-[#1a1a1a] border border-[#8AE600]/30 p-6 rounded-2xl shadow-2xl text-center"
            >
              <h2 className="text-2xl font-bold mb-2 text-white">Stranded? We’ve Got You Covered!</h2>
              <p className="text-[#8AE600] font-semibold mb-4 flex items-center justify-center gap-2">
                <Phone size={18} /> CALL US NOW
              </p>
              <motion.a
                whileHover={{ scale: 1.05, backgroundColor: '#72BE00' }}
                whileTap={{ scale: 0.95 }}
                href="tel:03335778247"
                className="block w-full bg-[#8AE600] text-black font-bold py-3 px-6 rounded-lg transition mb-4 shadow-lg"
              >
                0333 577 8247
              </motion.a>
              <p className="text-sm mb-2 text-gray-400 flex items-center justify-center gap-1">
                <MapPin size={16} className="text-[#8AE600]" /> ENTER YOUR POSTCODE OR LOCATION
              </p>
              <form className="space-y-3">
                <motion.input
                  whileFocus={{ scale: 1.02, borderColor: '#8AE600' }}
                  type="text"
                  placeholder="Postcode or location"
                  className="w-full px-4 py-2 rounded-lg bg-[#0A0A0A] border border-[#8AE600]/30 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#8AE600]"
                />
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  type="submit"
                  className="w-full bg-[#8AE600] hover:bg-[#72BE00] text-black font-bold py-2 px-4 rounded-lg transition shadow-lg"
                >
                  SUBMIT
                </motion.button>
              </form>
        ...
        >
          ...
          <div className="absolute inset-0 opacity-10">
            <TyreIcon className="absolute top-10 left-10 w-24 h-24 text-[#8AE600]" />
            <TyreIcon className="absolute bottom-10 right-10 w-32 h-32 text-[#8AE600]" />
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <motion.div
                variants={scaleIn}
                whileHover={{ scale: 1.02 }}
                className="relative h-64 md:h-96 rounded-2xl overflow-hidden shadow-2xl border border-[#8AE600]/30"
              >
                <Image
                ...
                <Car className="absolute bottom-4 left-4 text-[#8AE600] w-12 h-12 opacity-50" />
              </motion.div>
              <motion.div variants={staggerChildren} className="text-center md:text-left">
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  href="tel:03335778247"
                  className="inline-block bg-[#8AE600] hover:bg-[#72BE00] text-black font-bold py-3 px-8 rounded-full transition shadow-lg border-2 border-transparent hover:border-white"
                >
                  BOOK NOW
                </motion.a>
              </motion.div>
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              <span className="border-b-4 border-[#8AE600] pb-2">We specialise in</span>
            </motion.h2>
          </div>
        </motion.section>
          ...
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
            <motion.div variants={staggerChildren} className="order-2 md:order-1">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="tel:03335778247"
                className="inline-block bg-[#8AE600] hover:bg-[#72BE00] text-black font-bold py-3 px-8 rounded-full transition shadow-lg"
              >
                BOOK NOW
              </motion.a>
            </motion.div>
            <motion.div
              variants={scaleIn}
              whileHover={{ scale: 1.02 }}
              className="order-1 md:order-2 relative h-64 md:h-96 rounded-2xl overflow-hidden shadow-2xl border border-[#8AE600]/30"
            >
              <Image
                src="/15.png"
                alt="Rapid response"
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A] to-transparent"></div>
              <Timer className="absolute bottom-4 right-4 text-[#8AE600] w-12 h-12 opacity-50" />
            </motion.div>
          </div>
        </motion.section>
        ...
        >
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <Award className="absolute bottom-4 left-4 text-[#8AE600] w-12 h-12 opacity-50" />
            </motion.div>
            <motion.div variants={staggerChildren}>
              <motion.h3 variants={fadeInUp} className="text-2xl md:text-3xl font-bold mb-4 text-white flex items-center gap-2">
                <Award className="text-[#8AE600]" /> National Recovery
              </motion.h3>
              <motion.p variants={fadeInUp} className="text-gray-300 mb-4">
        ...
        >
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
            <motion.div variants={staggerChildren} className="order-2 md:order-1">
              <motion.h3 variants={fadeInUp} className="text-2xl md:text-3xl font-bold mb-4 text-white flex items-center gap-2">
                <Wrench className="text-[#8AE600]" /> Transporting
              </motion.h3>
              <motion.p variants={fadeInUp} className="text-gray-300 mb-4">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A] to-transparent"></div>
              <Truck className="absolute bottom-4 right-4 text-[#8AE600] w-12 h-12 opacity-50" />
            </motion.div>
          </div>
        </motion.section>
