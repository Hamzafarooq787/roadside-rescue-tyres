  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className="relative">
        {/* Pulsing ring */}
        <span className="absolute inset-0 rounded-full bg-[#19d1bf] opacity-75 animate-ping"></span>
        ...
        <a
          ...
          className="relative flex items-center justify-center w-16 h-16 bg-[#19d1bf] text-white rounded-full shadow-lg hover:bg-[#14b8a6] transition transform hover:scale-110 animate-float-icon"
        >
