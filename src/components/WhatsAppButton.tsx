  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className="relative">
        {/* Pulsing ring */}
        <span className="absolute inset-0 rounded-full bg-[#25E2F4] opacity-75 animate-ping"></span>
        ...
        <a
          ...
          className="relative flex items-center justify-center w-16 h-16 bg-[#25E2F4] text-white rounded-full shadow-lg hover:bg-[#1BBECE] transition transform hover:scale-110 animate-float-icon"
        >
