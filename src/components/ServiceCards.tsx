            ...
            return (
              ...
              >
                ...
                <div className="px-6 pt-8">
                  ...
                  <button className="bg-[#102122] text-white px-10 py-3 tracking-widest transition-all duration-300 transform hover:scale-105 hover:bg-[#0D6B7A] hover:shadow-lg flex items-center justify-center gap-2 mx-auto group/btn">
                    <span>BOOK NOW</span>
