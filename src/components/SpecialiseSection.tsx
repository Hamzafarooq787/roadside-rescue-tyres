...
export default function SpecialiseSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full bg-[#19d1bf] py-20 overflow-hidden"
    >
            ...
            >
              ...
              <div className={`p-12 ${isEven ? 'md:pl-16' : 'md:pr-16'}`}>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-black text-white px-8 py-4 font-semibold transition-all duration-300 transform hover:scale-105 hover:bg-teal-700 hover:shadow-lg group/btn"
                >
                  <span>BOOK NOW</span>
