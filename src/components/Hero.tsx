...
<div className="mb-[70px]">
    ...
    <div className="flex justify-center">
      <a
        ...
        className="inline-flex items-center justify-center gap-3 bg-emerald-500 hover:bg-emerald-600 text-black font-bold py-4 px-10 rounded-lg text-2xl transition-all duration-300 transform hover:scale-110 hover:shadow-[0_0_20px_#10b981] animate-button shadow-lg relative overflow-hidden group"
      >
        ...
        <span className="relative">
          {/* Signal wave ring */}
          <span className="absolute inset-0 animate-signal-wave bg-emerald-300 rounded-full pointer-events-none"></span>
          {/* Actual icon */}
